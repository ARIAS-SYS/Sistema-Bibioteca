                ...
                <div class="card-body">
                    <form action="controller_delete.php" method="post">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombres" value="<?php echo $sesion_nombres?>" class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Apellidos</label>
                                    <input type="text" value="<?php echo $sesion_apellidos?>" name="apellidos" class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">CI</label>
                                    <input type="number" value="<?php echo $sesion_ci?>" name="ci" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="<?php echo $sesion_celular?>" name="celular" class="form-control" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Cargo</label>
                                    <select name="cargo" class="form-control" disabled id="">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" value="<?php echo $sesion_email?>" name="email" class="form-control" disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button type="submit" onclick="return confirm('¿Desea eliminar este registrode la base de datos?')" class="btn btn-danger btn-block">Eliminar Usuario</button>
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                    </form>
