...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Sis</b> BLIOTECA</a>
    </div>
    <div class="card-body">
      <!-- <p class="login-box-msg">Sign in to start your session</p> -->
        
        <center>
              <img width="158px" src="https://lh3.googleusercontent.com/proxy/ezOxGejRRmHnvThq7kvG_5maFhgRn0MIwNoQxOMi2r1lvdegOIDfSntjhBvOaspYTcuTEemxSGhP8qIG4TcvuZvbPr4o_G9fw7ALVeKmq40eZPRIHg" alt="">
        </center>
        <br>
